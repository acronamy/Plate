interface systemPages{
    /**
     * Provide a path to file relative to defined views directory.
...
export default interface ModuleConfig{
    ...
    */
    port:number;
    /**
     * Plate uses the concept of mounts in the same way Django creates apps, each mount must be declared here or Pipkin wont know the mount exists.
    */
    declarations:any[];
    /**
    ...
    */
     ...
     * - installs fetures such as routes, mounts or services
     * - other menipulations
    */
    imports:Function[]
}